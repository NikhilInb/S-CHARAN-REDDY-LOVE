...
<head>
  ...
  <title>Cute Valentines Day</title>
...
<body class="gradient-background">
  <div class="flex items-center justify-center h-screen">
    <div class="flex flex-col items-center p-4">
      <img id="imageDisplay" src="https://media.giphy.com/media/121623div4cJhi/giphy.gif" alt="Cute puppy valentine heart" class="rounded-md h-[300px]" style="object-fit: cover;" />
  ...
  <script type="module">
    ...
    let fontSize = 20;
    const imagePaths = [
      "https://media.giphy.com/media/121623div4cJhi/giphy.gif",  // Adorable puppy with heart balloon[web:21][web:15]
      "https://media.giphy.com/media/VWuaHAU54Fwrq/giphy.gif",  // Cute pleading puppy eyes[web:15]
      "https://media.tenor.com/PagX1dXbY1AAAAAd/kawaii-valentines.gif",  // Kawaii sad face heart[web:24]
      "https://media.giphy.com/media/26tPplGWjKxWooFuU/giphy.gif",  // Sweet cat with hearts[web:23]
      "https://media.giphy.com/media/xT9IgzoW9mXNNvsfZy/giphy.gif",  // Bunny love pleading[web:9]
      "https://media.giphy.com/media/3ohhwBe2BTUHn53kI0/giphy.gif"  // Kawaii crying heart[web:24]
    ];
    ...
    yesButton.addEventListener('click', () => {
      imageDisplay.src = 'https://media.giphy.com/media/l41lViv8BfuI5PGiE/giphy.gif';  // Super cute happy puppy celebration[web:21]
